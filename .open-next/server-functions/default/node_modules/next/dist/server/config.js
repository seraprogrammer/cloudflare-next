...
function assignDefaults(dir, userConfig, silent) {
    ...
    if (!((_process_env___NEXT_VERSION = "15.1.8") == null ? void 0 : _process_env___NEXT_VERSION.includes('canary')) && !process.env.__NEXT_TEST_MODE && !process.env.NEXT_PRIVATE_SKIP_CANARY_CHECK) {
